...
urlpatterns = [
    ...
    path('available-art/', views.dashboard_availableart, name='dashboard_availableart'),
    ...
    path('journal/', views.dashboard_journal, name='dashboard_journal'),
    ...
    path('exhibition/', views.dashboard_exhibition, name='dashboard_exhibition'),
    path('exhibition/add/', views.exhibition_add, name='exhibition_add'),
    path('exhibition/<int:pk>/edit/', views.exhibition_edit, name='exhibition_edit'),
    path('exhibition/<int:pk>/delete/', views.exhibition_delete, name='exhibition_delete'),
]
